...
class CadastroCidadeForm(FlaskForm):
    ...
    descricao_cidade = TextAreaField(
        "Descrição da cidade", description=DESCRICAO["desc_cidade"])

    favorita = BooleanField("Cidade favorita")

    notificacao = BooleanField(
        "Notificações por e-mail", description=DESCRICAO["notificacao"])
...
class EdicaoCidadeForm(FlaskForm):
    ...
    notificacao = BooleanField(
        "Notificação por e-mail", description=DESCRICAO["notificacao"])
...
class AvaliacaoSiteForm(FlaskForm):
    ...
    comentario = TextAreaField(
        "Comentário sobre o site", description=DESCRICAO["comentario"])
...
class PesquisarCidadeForm(FlaskForm):
    nome_cidade = StringField("Pesquisar cidade por nome:", validators=[
